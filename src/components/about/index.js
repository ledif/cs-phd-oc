        ...
        <div className="container">
          <div className="column">
            <div className="content about">
              ...
              <p>
              The <a href="https://www.nsf.gov/statistics/2018/nsf18304/data/tab31.pdf">National Science Foundation</a> reports that the median time to receive a computer science doctorate after a bachelor's degree is 7.9 years. In recent times, fewer PhD graduates are following the tenure-track faculty route (for a variety of reasons) and are instead choosing software engineering positions. The doctorate itself may not increase a software engineer's compensation to the point of making up for the lost wages incurred during their graduate studies. Doctoral stipends are often enough to cover living expenses, but are nowhere near the compensation that an entry-level software engineer would receive. By pursuing a PhD and receiving a doctoral stipend, a graduate student who intends to work as a software engineer after their degree might end up missing out on hundreds of thousands of dollars of income.
              </p>
              <p>
